		...
		for(int i = 0; i < _coreServer->_cenarioList->size(); i++)
			{
				...
				{
					/*float x = _coreServer->_cenarioList->getElementAt(i)->getMonsterAt(j)->getPosition()->x + 0.1f;
					float z = _coreServer->_cenarioList->getElementAt(i)->getMonsterAt(j)->getPosition()->z + 0.1f;
