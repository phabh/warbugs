...
public:
	...
	virtual void draw3DTabBody(irr::gui::IGUIElement *,bool,bool,const irr::core::rect<s32> &,const irr::core::rect<s32> *,irr::s32,irr::gui::EGUI_ALIGNMENT/*IGUIElement *element, bool border, bool background, const core::rect<s32> &rect, const core::rect<s32> *clip*/);
	...
	//void draw3DTabButton(IGUIElement* element, bool active,	const core::rect<s32>& rect, const core::rect<s32>* clip=0, gui::EGUI_ALIGNMENT alignment=EGUIA_UPPERLEFT);
	//virtual void draw3DTabBody(IGUIElement *element, bool border, bool background, const core::rect<s32> &rect, const core::rect<s32> *clip);
};
