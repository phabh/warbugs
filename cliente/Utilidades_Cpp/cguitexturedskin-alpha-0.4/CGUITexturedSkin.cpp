...
void CGUITexturedSkin::draw3DTabBody(irr::gui::IGUIElement *element,bool border, bool background,const core::rect<s32> &rect, const core::rect<s32> *clip,irr::s32,irr::gui::EGUI_ALIGNMENT/*IGUIElement *element, bool border, bool background, const core::rect<s32> &rect, const core::rect<s32> *clip*/)
{
